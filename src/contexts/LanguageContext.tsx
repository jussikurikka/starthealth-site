...
const translations = {
    ...
    'services.basicOmply.desc': 'Etävastaanotto, jolla lääkäri myös tutkii',
    'services.basicOmply.feature1': 'Kaikki Basic-paketin palvelut',
    'services.basicOmply.feature2': 'Etätutkimuslaitteet työntekijöille',
    'services.basicOmply.feature3': 'Lääkäri kuuntelee sydän- ja keuhkoäänet sekä tutkii korvat ja ihon etänä',
    'services.basicOmply.feature4': 'Lämpö, happisaturaatio ja verenpaine mitataan vastaanoton aikana',
    'services.basicOmply.badge': 'Uutuus',
    'services.basicOmply.priceNote': 'Aloitusmaksu 499 € · laitteet laitepaketin laajuuden mukaan · n. 47 €/hlö/kk',
  ...
  en: {
    ...
    'services.basicOmply.name': 'Basic + Omply',
    'services.basicOmply.desc': 'Remote consultations where the doctor can also examine',
