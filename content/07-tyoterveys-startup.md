...
meta_description: "Startup-yrityksen työterveys: milloin aloittaa, paljonko maksaa, mitä sisältyy ja miksi perinteinen työterveys ei sovi startupille. Käytännön opas."
...
Heti kun palkkaat ensimmäisen työntekijän, lakisääteinen työterveyshuolto (Kela 1 -taso) muuttuu pakolliseksi. Velvoite ei odota perustamisvuoden loppuun eikä ensimmäistä Series A:ta — se alkaa työsuhteen alkaessa.

Käytännössä tarkoittaa, että **työterveyssopimus on oltava allekirjoitettuna ja työpaikkaselvitys alkamassa** kun ensimmäinen työntekijä aloittaa.
...
Perustaja-yrittäjä ei kuulu automaattisesti työterveyden piiriin, mutta sen voi hankkia itselleen vapaaehtoisesti. Starthealthin paketit sisältävät yrittäjän itsensä — yhtenäisen hinnoittelun osana.

Kela myöntää korvausta myös yrittäjän työterveydestä (tietyin edellytyksin).

## 7. Miten startupin pitäisi valita työterveys

Järjestä valinta näin:

1. **Arvioi realistinen käyttö** — nuori tiimi käyttää vähän, vältä ylimitoitettua pakettia
2. **Valitse digitaalisesti edellä oleva toimija** — etävastaanotot ja moderni app
...
### Onko työterveys pakollinen kolmen hengen startupille?
Kyllä. Velvoite alkaa ensimmäisestä työntekijästä. Poikkeus: perustajat itse eivät ole automaattisesti piirissä.

### Milloin startupin pitäisi hankkia Kela 2 -taso?
Heti. Kela 2 (sairaanhoito) on käytännössä välttämätön rekrytointikilpailussa. Pelkkä Kela 1 -taso ei ole riittävä kilpailuetu.

### Voiko startupin työterveyden hoitaa pelkästään etänä?
...
## Varaa aika tai pyydä tarjous startupin työterveydestä
